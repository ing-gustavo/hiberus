        ...
        <div class="flex flex-col w-full ">
            ...
            <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                    ...
                    <p class="mt-2 text-sm text-gray-700">A list of all the drivers.</p>
                </div>
                <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                    <a href="{{ route('drivers.create') }}" class="block rounded-md bg-indigo-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Add driver</a>
                </div>
            </div>
                                    ...
                                    @forelse($drivers as $driver)
                                        <tr>
                                            ...
                                            <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                                <a href="/drivers/{{ $driver->id }}/edit" class="text-indigo-600 hover:text-indigo-900">Edit<span class="sr-only">,{{ $driver->name }}</span></a>
                                            </td>
                                            <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
    ...
    @push('scripts')
        <script>
            document.onsubmit = function(){
                return confirm('Are you certain you wish to remove this driver?');
            }
        </script>
    @endpush
</x-layout>
